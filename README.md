...
MKE analyer plugin for the [Kingst](http://www.qdkingst.com/en) branded Logic Analysers. This was developed using their SDK. <br/>  <br/> **Minimum Sample Rate of 200Mhz is required**
...
## What It Can Do
I tried to implement as many features as possible within reason. This has been designed around the Original Xbox MKE implementation so is limited to Memory and IO Read and Writes. **LFRAME signal is required though.**  
...
4. Combines Address nibbles accordingly in text bubbles as per the MKE spec. <br/> ![enter image description here](https://i.imgur.com/eiPMQBT.png)
...
2. Open `MKEAnalyzer.vcxproj` in the vs2019 folder.
...
2. Copy the `libMKE.so` copied to the KingstVIZ software `Analyzer` folder. 
